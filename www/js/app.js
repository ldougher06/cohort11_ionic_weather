...
.run(function($ionicPlatform) {
  ...
  .controller('weatherCtrl', function ($http) {
    ...
    weather.search = function () {
      ...
      .then(parseWUData)
      .then(function (res) {
        var locationID = JSON.stringify(res.data.current_observation.display_location.full);
        var stationID = JSON.stringify(res.data.current_observation.station_id);

        localStorage.setItem('seachHistory', locationID);
      })
    }
